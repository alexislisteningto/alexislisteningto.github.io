/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 8331fe96dc075bc78c7d6f6838e3abd9)
// Runtime types generated with workerd@1.20260730.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
	RECOMMEND_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	LASTFM_USER: "nobody__home";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LASTFM_USER" | "LASTFM_API_KEY" | "DISCORD_WEBHOOK_URL" | "TURNSTILE_SITE_KEY" | "TURNSTILE_HOSTNAMES" | "ALLOWED_ORIGINS" | "TURNSTILE_SECRET">> {}
}
